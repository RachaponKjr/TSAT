...
import { Plus, Wrench, Save, X, AlertTriangle, Image as ImageIcon, FileText } from 'lucide-react'
...
const AddService = () => {
    ...
    const submitAdd = async () => {
        ...
        try {
            ...
            toast.error('เกิดข้อผิดพลาดในการเพิ่มเซอร์วิส', { className: '!text-red-500' })
        } finally {
                    ...
                    <div className='space-y-4'>
                        ...
                        <div className='space-y-4'>
                            <div className='space-y-1'>
                                ...
                                <TextareaWithLabel
                                    ...
                                    className={`min-h-[100px] ${errors.serviceDetail ? 'border-red-500' : ''}`}
                                />
                                {errors.serviceDetail && (
                                    <div className='flex items-center gap-1'>
                                        <AlertTriangle size={12} className='text-red-500' />
                                        <p className='text-xs text-red-500'>{errors.serviceDetail}</p>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className='space-y-1'>
                                ...
                                <TextareaWithLabel
                                    ...
                                    className={`min-h-[100px] ${errors.explain ? 'border-red-500' : ''}`}
                                />
                                {errors.explain && (
                                    <div className='flex items-center gap-1'>
                                        <AlertTriangle size={12} className='text-red-500' />
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                            <div className='space-y-1'>
                                ...
                                <div className={`border-2 border-dashed rounded-lg p-2 ${errors.images ? 'border-red-500' : 'border-gray-300'}`}>
                                    <ImageMultiUpload
                            ...
                            <div className='space-y-1'>
                                ...
                                <div className={`border-2 border-dashed rounded-lg p-2 ${errors.icon ? 'border-red-500' : 'border-gray-300'}`}>
                                    <ImageBoxUpload
                        ...
                        <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
                            <div className='flex items-start gap-2'>
                                <Wrench className='text-blue-600 flex-shrink-0 mt-0.5' size={16} />
