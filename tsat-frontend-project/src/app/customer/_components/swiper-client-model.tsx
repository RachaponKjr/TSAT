                ...
                {carModel.map((item, index) => (
                    <SwiperSlide key={index}>
                        <div className='flex flex-col items-center'>
                            <Image unoptimized src={`http://150.95.26.51:3131/${item.image}`} alt="modelcar" width={500} height={500} />
                            <Image unoptimized src={`http://150.95.26.51:3131/${item.imageName}`} alt="modelcar" width={200} height={200} />
                        </div>
                    </SwiperSlide>
                ))}
            </Swiper>
